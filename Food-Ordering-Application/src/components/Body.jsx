		...
		<div className="body">
			<div className="flex flex-col items-center justify-between gap-2 my-4">
				<div className="my-4">
					<input
						id="searchIP"
						className="border m-1 p-1 rounded-sm"
						type="text"
						value={searchText}
						onChange={(e) => {
					...
					<button
						className="w-20 m-1 p-1 bg-gray-200 rounded-xl cursor-pointer font-medium transition duration-300 ease-in-out hover:bg-amber-400"
						onClick={() => {
				...
				<button
					className=" bg-gray-200 w-50 m-1 p-1 sm:p-2 sm:m-2 rounded-lg cursor-pointer font-medium transition duration-300 ease-in-out hover:text-amber-500"
					onClick={() => {
			...
			<div className=" flex flex-col items-center sm:grid sm:grid-cols-3 lg:grid lg:grid-cols-5 ">
